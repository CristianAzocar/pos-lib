...
{
    /// <summary>
    /// Represents the code page of the printer.
    /// </summary>
    internal class StarIOCodePage
    {
        /// <summary>
        /// Returns the code page command.
        /// </summary>
        /// <param name="codePage">The code page to get the command.</param>
        /// <returns>The code page command.</returns>
        public string GetCodePageCommand(string codePage)
        {
            switch (codePage)
            {
                ...
                default:
                    throw new InvalidOperationException("The code page is not defined.");
            }
        }
    }
}
